...
filenames_euvil_195 = sorted(glob.glob(path_to_files+'*eu_L.fts'))
filenames_euvir_195 = sorted(glob.glob(path_to_files+'*eu_R.fts'))
# Benoit: Needs fixing
filenames_eit_171 = sorted(glob.glob(path_to_files+'eit_l1*'))
filenames_euvil_171 = sorted(glob.glob(path_to_files+'*eu_L.fts'))
filenames_euvir_171 = sorted(glob.glob(path_to_files+'*eu_R.fts'))
# Benoit: Needs fixing
filenames_eit_304 = sorted(glob.glob(path_to_files+'eit_l1*'))
filenames_euvil_304 = sorted(glob.glob(path_to_files+'*eu_L.fts'))
filenames_euvir_304 = sorted(glob.glob(path_to_files+'*eu_R.fts'))
